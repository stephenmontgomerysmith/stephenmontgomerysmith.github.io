...
# ppmtopng (part of the netpbm package http://netpbm.sourceforge.net/ )
#
...
#     "time taken to make the \`png\' file.)\n",
      ...
      "If you have any suggestions to improve this site, or the natural ",
      "math language, please email me at ",
      "<a href=\"mailto: stephen\@math.missouri.edu\">stephen\@math.missouri.edu</a>.",p,
      center(
      start_form,
      textarea("nmtext",
...
if (param())
{
  ...
  print GS "quit\n";
  close(GS);
  system "pnmtopng -transparent white afile$ident.ppm > afile$ident.png 2>/dev/null;" .
         "rm -f *.aux *.cpm *.ppm *.dvi *.log *.ppm *.ps *.tex;";

  print "<center>Here is what it looks like.</center>",p,
        "\n<center><img src=\"$TEX_STUFF/afile$ident.png\" ",
        "width=$bbw height=$bbh align=abscenter ",
        "alt=\"This is a visual representation of the equation you typed.\"></center>\n",
        p,"You can use this image for yourself: download the <a href=\"$TEX_STUFF/afile$ident.png\">image</a>",
        " and use HTML something like:",br,
        "<tt>&lt;img src=\"image.png\" width=$bbw height=$bbh align=abscenter alt=\"The picture.\"></tt>";
